...
def format_date_time(timestamp):
    ...
    if diff.days < 2: 
        ...
        ntime = str(format(date_time.hour, '02d'))+":"+str(format(date_time.minute, '02d'))
    return ndate, ntime    
    ...
    for i, n in enumerate(nav_filter_list):
        ...
        try:
            ...
            if json_news != []:
                ...
                if ndate != "":
                    n.append({"title":json_news[0]["t"],"date":ndate,"time":ntime,"link":json_news[0]["u"]})
                else:
    ...
    for i, p in enumerate(pos_filter_list):
        ...
        try:
            ...
            if json_news != []:
                ndate, ntime = format_date_time(json_news[0]["tt"])
                if ndate != "":
                    p.append({"title":json_news[0]["t"],"date":ndate,"time":ntime,"link":json_news[0]["u"]})
                else:
